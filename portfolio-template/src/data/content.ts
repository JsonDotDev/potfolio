...
export const projects: Project[] = [
  ...
  },
  {
    ...
    overview: [
      ...
      'On competition day, despite an unexpected battery connection issue during setup (a soldered plug had broken, fortunately we caught it and swapped a backup in just before our run), the robot performed as intended both times and delivered a final time of 3.7 seconds, placing 4th overall.',
    ],
    challenges: [
      'Early arm designs were too heavy, so we iterated through four major revisions, cutting weight-saving slots and reworking geometry until the torque requirements were actually achievable by the motors.',
    ...
    whatIdDoDifferently: [
      ...
      'Mount the motor driver and battery plug permanently to the backboard, as loose connections were the cause of the pre-run scare on competition day.',
    ],
    gallery: [
